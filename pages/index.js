...
export default function Swap() {
  ...
  const setFrontrun = (elem) => {
    ...
    <span class=${styles.tooltiptext}>Your transaction may be frontrun.</span>
    `
  }
  ...
  const setFail = (elem) => {
    ...
    <span class=${styles.tooltiptext}>Your transaction may fail.</span>`
  }
  ...
  return (
    <div className={`${styles.container} ${styles.unselectable}`} onClick={closeSettings}>
      <Head>
          ...
          <div className={styles.swap_header}>
            <div className={styles.settings_icon}>
              <button id="settings_toogle_btn" className={styles.settings_toogle} onClick={toogleSettings}>
                ...
                <div className={styles.expert_mode}>
          ...
          <div className={styles.tx_settings_div}>
            <div className={styles.info_row}>
              ...
              <div className={`${styles.question_icon} ${styles.tooltip}`}>
                ...
                <span class={styles.tooltiptext}>Your transaction will revert if the price changes unfavorably by more than this percentage.</span>
              </div>
            </div>
