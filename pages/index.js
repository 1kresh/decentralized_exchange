...
export default function Swap() {
  ...
  const setFrontrun = (elem) => {
    elem.innerHTML = `
    <svg className=${styles.slip_svg} xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
    ...
    <span className=${styles.tooltiptext_down}>Your transaction may be frontrun.</span>
    `
  }

  const setFail = (elem) => {
    elem.innerHTML = `<svg className=${styles.slip_svg} id="svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0, 0, 400,400">
    ...
    <span className=${styles.tooltiptext_down}>Your transaction may fail.</span>`
  }
