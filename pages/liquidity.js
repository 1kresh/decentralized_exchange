      ...
      <nav className="navbar navbar-light fixed-top">
        ...
        <div className={styles.menu_main}>
          <div id="menuDiv" className={`${styles.menu} ${styles.toggle_init}`}>
            <div
              id="swpBtn"
              className={`${styles.swap_button} ${styles.menu_button} ${styles.hover_effect}`}
              onMouseDown={togglePage}
            >
              Swap
            </div>
            <div
              className={`${styles.liquidity_button} ${styles.menu_button}`}
              onClick={pageUp}
            >
              Liquidity
            </div>
          ...
          {!address ? (
            ...
            <div className={`${styles.account_div_main}`}>
              ...
              >
                ...
                <div ref={avatarRef} className={styles.avatar_div}></div>
              </div>
            </div>
          )}
        </div>
